...
// If you created SectionHeading earlier, you can use it here instead of the h2
// import SectionHeading from "./SectionHeading";
import cvfile from "../assets/Sadik_Rahman_CV.pdf";
import SectionHeading from "./SectionHeading";
    ...
    return (
        <section id="cv" className="mt-10 relative min-h-[40vh] flex items-center justify-center py-20 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-3xl mx-auto px-4 text-center">
               ...
               font-medium text-white shadow-lg shadow-emerald-600/20
               ...
               font-medium text-emerald-300 hover:text-emerald-200 hover:bg-emerald-500/10
